    ...
    <div>
        <div class="jumbotron dark-background">
            ...
            <div style="width: 75%; margin: 0 auto;">
                <p class="w-responsive text-center mx-0">Ever since I started learning coding, there has been various projects here and there, below are a few examples which I am proud of</p>
            </div>
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="main-timeline4">
                        <div class="timeline">
                            <a href="#" class="timeline-content">
                                ...
                                <div class="inner-content">
                                    <h3 class="title">TauCeti (Work in Progress)</h3>
                                    <p class="description">
                                        PLACEHOLDER description: A website that's designed to help students share notes, thoughs and all things university related
                                    </p>
                                </div>
                            </a>
                        </div>
                        <div class="timeline">
                            <a href="#" class="timeline-content">
                                ...
                                <div class="inner-content">
                                    <h3 class="title">Pointr</h3>
                                    <p class="description">
                                        PLACEHOLDER description: Initially conceived and implemented as a hackathon entry, since then, pivoted towards general university societies related functionalities
                                    </p>
                                </div>
                            </a>
                        </div>
                        <div class="timeline">
                            <a href="#" class="timeline-content">
                                <span class="year">2019</span>
                                <div class="inner-content">
                                    <h3 class="title">Chibaba</h3>
                                    <p class="description">
                                        PALCEHOLDER description: My very first hackathon, participated in the CSESoc Hackathon, coded (well, more like Googled) the backend in 24 hours.
                                    </p>
                                </div>
                            </a>
                        </div>
                        <div class="timeline">
                            <a href="#" class="timeline-content">
                                ...
                                <div class="inner-content">
                                    <h3 class="title">Mandelbrot Set</h3>
                                    <p class="description">
                                        PLACEHOLDER description: A webapp coded in C to infinitely zoom into the Mandelbrot set.
                                    </p>
                                </div>
                            </a>
                        </div>
...
<style scoped>
/* I claim no part of the css written below, all credits go to https://bootsnipp.com/snippets/prmge */
/* TODO (Steven 13.07.2020): Use something less obtuse and more flexible than this */
...
.main-timeline4 .description{font-size:14px;color:white;margin:0 0 5px}
